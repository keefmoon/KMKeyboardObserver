#
#  Be sure to run `pod spec lint KMKeyboardObserver.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version       = "1.7"
  s.swift_version = "4.2"
  s.summary       = "A simple class to observer keyboard frame changes."
  ...
  s.source_files  = "KeyboardObserver/KeyboardObserver/**/*.{h,m,swift}"
  ...
  # s.dependency "OperationArchitecture", :git => 'git@github.com:keefmoon/operation-architecture.git'
